...
var UpdatePostService_1 = require("../../services/posts/UpdatePostService");
var UpdatePostController = /** @class */ (function () {
    function UpdatePostController() {
    }
    UpdatePostController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var errors, error, id, _a, title, content, service, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        service = new UpdatePostService_1.UpdatePostService();
                        return [4 /*yield*/, service.execute({ id: id, title: title, content: content })];
                    case 1:
                        result = _b.sent();
