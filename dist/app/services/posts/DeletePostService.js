...
var DeletePostService = /** @class */ (function () {
    ...
    DeletePostService.prototype.execute = function (id, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var repo, post;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        repo = (0, typeorm_1.getRepository)(Post_1.Posts);
                        return [4 /*yield*/, repo.findOne(id)];
                    case 1:
                        post = _a.sent();
                        if (!post) {
                            return [2 /*return*/, new Error('Post não existe')];
                        }
                        if ((post === null || post === void 0 ? void 0 : post.userId) != userId) {
                            return [2 /*return*/, new Error('Usuário não autorizado')];
                        }
