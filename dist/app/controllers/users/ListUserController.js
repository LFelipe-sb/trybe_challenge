...
var ListUserService_1 = require("../../services/users/ListUserService");
var ListUserController = /** @class */ (function () {
    ...
    ListUserController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, service, users, noId_1, user, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = request.params.id;
                        service = new ListUserService_1.ListUserService();
                    ...
                    case 1:
                        ...
                        user = users.map(function (item) {
                            return __assign({}, noId_1(item));
                        });
                        if (!id && !user.length || !user.length) {
                            return [2 /*return*/, response.status(404).json({ message: 'Usuário não existe' })];
                        }
                        if (id) {
                            return [2 /*return*/, response.status(200).json(user[0])];
                        }
                        else {
                    ...
                    case 2:
                        err_1 = _a.sent();
                        return [2 /*return*/, response.status(434).json({ message: 'Usuário não existe' })];
